...
func TestHandleHealth_ViaRouter(t *testing.T) {
	...
	router := NewRouterWithTemplates(mockPostService, mockAuthService, testSecureCookie, nil, testBlogTitle, testBaseURL, testTemplatePattern, testUploadDir, testMaxUploadSize)
