...
func TestHandleHealth_ViaRouter(t *testing.T) {
	...
	router := NewRouterWithTemplates(mockPostService, nil, mockAuthService, testSecureCookie, nil, testBlogTitle, testBaseURL, testTemplatePattern, testUploadDir, testMaxUploadSize, testPostsPerPage)
